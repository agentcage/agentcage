...
10. **Reverse-proxy header plumbing.** 8.6/8.6b cover the config half.
    The agentcage addon's inbound behavior — forwarded-header STRIPPING
    (openclaw 2.0 attribution; synthetic `X-Forwarded-For` was removed)
